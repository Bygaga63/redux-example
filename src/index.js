...
//еще раз по шагам
//1) создаем стор, засовываем в него корневой reduсer
//2) кладем его в провайдер
//3) вызываем MainComponent
//5) через методы putStateToProps, putActionsToProps засовываем методы и поля которые нам нужны в этом компоненте
